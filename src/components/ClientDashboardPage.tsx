...
import { V1_ENTITY_OPTIONS, getEntityLabel } from '../data/entityServiceCatalog';
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-x-4 text-sm text-gray-500 mt-1">
                                ...
                                <span className="bg-blue-100 text-blue-800 px-2 rounded-full text-xs flex items-center h-5 self-center">{getEntityLabel(client.entityType)}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-2xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-lg border">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800 font-medium">{V1_ENTITY_OPTIONS.find(e => e.id === client.entityType)?.name || client.entityType}</p>
                                </div>
                                <div>
