...
import OperationalLoginDropdown from './OperationalLoginDropdown';
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left gap-8">
            ...
            <div>
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                    <li><OperationalLoginDropdown role="partner" label="Partner / Agent Login" /></li>
                    <li><OperationalLoginDropdown role="associate" label="Associate Login" /></li>
                    <li><OperationalLoginDropdown role="admin" label="Admin Login" /></li>
                </ul>
            </div>
