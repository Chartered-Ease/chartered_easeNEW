...
const AssociateLoginPage: React.FC = () => {
        ...
        <div className="flex items-center justify-center min-h-[70vh] bg-gray-50 px-4 py-12">
            <div className="w-full max-w-sm p-8 space-y-6 bg-white rounded-lg shadow-xl">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-gray-800">Associate Login</h1>
                    <p className="mt-2 text-gray-600">Please sign in to your associate account.</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <p className="text-center text-xs text-gray-400 pt-2">For development, use: <span className="font-mono font-bold text-gray-600">Associate</span> / <span className="font-mono font-bold text-gray-600">1234</span></p>
                    ...
                    <div>
                     ...
                     <p className="px-8 text-center text-xs text-gray-500">
                        This portal is for authorized Chartered Ease associates only.
                    </p>
                </form>
            </div>
        </div>
